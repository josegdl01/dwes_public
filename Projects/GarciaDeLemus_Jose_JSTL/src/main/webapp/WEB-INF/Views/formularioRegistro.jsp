...
<form method="post">
    ...
    <label for="firstReg"><fmt:message key = "userFirstTag"/></label><input id="firstReg" type="text" name="firstReg"><br><br>
    <label for="lastReg"><fmt:message key = "userLastTag"/></label><input id="lastReg" type="text" name="lastReg"><br><br>
    ...
    <br><br>
    <a href="${pageContext.request.contextPath}"><fmt:message key="volverTag" /></a>
</form>
</body>
</html>